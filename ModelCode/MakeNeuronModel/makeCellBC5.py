execfile('parametersBC5Klt.py')
def makeCell(cellid, morphfile):
    
    import parametersBC5Klt as pm 
    import neuroml
    ...
    nml_doc2.includes.append(neuroml.IncludeType('./channelConvert/pas.channel.nml')) 
    nml_doc2.includes.append(neuroml.IncludeType('./channelConvert/Na_BC.channel.nml')) 
    nml_doc2.includes.append(neuroml.IncludeType('./channelConvert/K_BClt.channel.nml'))
    nml_doc2.includes.append(neuroml.IncludeType('./channelConvert/K_BC40act.channel.nml'))
